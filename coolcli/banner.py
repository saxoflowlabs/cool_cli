...
def print_saxoflow_banner_compact():
    """
...
def print_saxoflow_banner_alt_colors(console: Console):
    """
    Alternative version with different gradient colors using solid blocks.
    Uses a blue to green gradient with only █ characters (left to right).
    """
    # Alternative gradient: deeper blue to brighter green
    start_rgb = (30, 144, 255)   # Dodger blue
    end_rgb = (50, 205, 50)      # Lime green
    
    # Use the same solid SAXOFLOW art
    saxoflow_art = create_solid_saxoflow()
...
# def print_banner(console: Console):
#     """Prints a beautiful, stylized banner for the SaxoFlow CLI."""
    
#     # 1. Generate the ASCII art for the title using pyfiglet
#     ascii_art = pyfiglet.figlet_format("SaxoFlow", font="big")

#     # 2. Create a Rich Text object for the ASCII art
#     title_text = Text(ascii_art, justify="center")
   
#     # 3. Apply a smooth, multi-color gradient to the title
#     title_text.stylize("bold")
#     colors = ["cyan", "magenta", "yellow"]
#     num_colors = len(colors)
#     text_len = len(title_text)
#     for i, color in enumerate(colors):
#         start = i * text_len // num_colors
#         end = (i + 1) * text_len // num_colors
#         title_text.stylize(color, start, end)
#    # 4. Create a subtitle
#         subtitle_text = Text(
#         "Your AI-powered software engineering companion.",
#         justify="center",
#         style="italic dim",
#         )
   
#    # 5. Combine the title and subtitle into a single Text object for alignment
#         banner_text = Text("\n")
#         banner_text.append(title_text)
#         banner_text.append("\n\n")
#         banner_text.append(subtitle_text)
   
#    # 6. Create a panel to wrap the entire banner for a polished look
#         banner_panel = Panel(
#         banner_text,
#         title="[bold white]Welcome to the SaxoFlow CLI[/bold white]",
#         border_style="magenta",
#         padding=(2, 4),
#         expand=False
#         )

#    # 7. Print the final banner to the console
